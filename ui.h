...
/* speed */
#define REX_GAME_PTERODACTYL_SPEED 7.5f
...
/* pterodactyl */
#define REX_GAME_PTERODACTYL_Y_POSITION_1 375
#define REX_GAME_PTERODACTYL_Y_POSITION_2 430
#define REX_GAME_PTERODACTYL_Y_POSITION_3 485
