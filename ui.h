...
#define REX_GAME_OBSTACKLE_MOVE_SPEED REX_GAME_HORIZON_LINE_ROLL_SPEED
#define REX_GAME_SPEED 1

#define REX_GAME_CREATE_OBSTACKLE_AFTER_FRAME_MAX 1000
...
#define END_SCENE_RESTART_Y 480
